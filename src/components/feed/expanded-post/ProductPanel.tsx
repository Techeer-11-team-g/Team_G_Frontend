...
export const ProductPanel = memo(function ProductPanel({
  selectedObject,
  selectedProduct,
  availableSizes,
  selectedSizeCodeId,
  ...
  if (!selectedObject || !selectedProduct) return null;
    ...
    <AnimatePresence>
      <>
        ...
        >
          ...
          <div className="overflow-y-auto px-4 pb-6" style={{ maxHeight: 'calc(50vh - 40px)' }}>
